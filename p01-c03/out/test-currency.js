...
console.log('10 Canadian dollars equals this amount of US dollars:', currency.canadianToUS(10));
console.log('9.1 US dollars equals this amount of Canadian dollars:', currency.USToCanadian(9.1));